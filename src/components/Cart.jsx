...
import dogCourier from '../assets/bye.png';
        ...
        <section className="cartSection">
          ...
          {userCartItems.length > 0 ? (
            ...
            <section className="emptyCartSection">
              <img src={EmptyCart} alt="Empty Cart" height="250px" />
          ...
          >
            ...
            <DialogContent className="dialogContent">
              <Typography variant="h6" color="rgb(2, 136, 209)">
            ...
            <DialogActions className="dialogActions">
              <Chip
                icon={<PriorityHighIcon color="info" />}
                label="go to test 404 page"
                color="info"
                variant="outlined"
